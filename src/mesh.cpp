...
namespace mesh_controller
{
    ...
    void start_mesh()
    {
        ...
        /* mesh softAP - internal mesh AP network*/
        ...
        #if ROOT_NODE
        // /* router - outside device to connect to */
        esp_mesh_set_type(MESH_ROOT);
        // const wifi_config_t *parent, const mesh_addr_t *parent_mesh_id, mesh_type_t my_type, int my_layer
        // ESP_ERROR_CHECK(esp_mesh_set_parent());

        #else

        // ESP_ERROR_CHECK(esp_mesh_fix_root(true));
        esp_mesh_set_type(MESH_LEAF); // Try to be a leaf
        ...
        // ESP_ERROR_CHECK((true)); // Allow mesh to switch channel to match router
